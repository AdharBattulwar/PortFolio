        ...
        <div className='navbarWrapper'>
            <div className='navbarMain'>
                ...
                <div className='navbarResume'>
                    <a href='https://res.cloudinary.com/dz9tzcoyr/image/upload/v1761380726/Resume_Oct_2025_edokpl.pdf' target='_blank' rel="noreferrer" download="AdharBattulwarResume.pdf" className='navbarAResume'>Resume</a>
                </div>
