      ...
      <div className="projectWrapper">
        <div className="projectTop">
          <div className="projectTopLeft">
            <h3>
              Lets have a Look At
              <br /> my <span>Projects</span>
            </h3>
          </div>
          <div className="projectTopRight">
            <div className="projectTopRightButton">Scroll to See All</div>
          </div>
        </div>
        ...
        <div className="projectBottom">
          <div className="projectBottomTop">
            {/* Technical skills */}
            <div className="projectBottomTopButton">Node.js</div>
            <div className="projectBottomTopButton">React</div>
            <div className="projectBottomTopButton">Next.js</div>
            <div className="projectBottomTopButton">MongoDB</div>
            <div className="projectBottomTopButton">PostgreSQL</div>
            <div className="projectBottomTopButton">Express</div>
            <div className="projectBottomTopButton">Hono</div>
            <div className="projectBottomTopButton">Java</div>
            <div className="projectBottomTopButton">Agentic AI</div>
          </div>
          <div className="projectBottomBottom">
            <div className="projectBottomBottomTop">
              <h4>DashStack - Student Management System</h4>
